...
public class ObjetoEnviaEmail {
	...
	public void enviarEmailAnexo(boolean envioHtml) throws Exception {
		...
		arquivos.add(simuladordePDF()); /*Primeiro poderia ser qualquer coisa*/
	...
	/**
	 * O método abaixo simula o PDF de qualquer arquivo que possa ser enviado por
	 * anexo no email você pode pegar o arquivo no banco, em b64, byte[], stream de
	 * arquivos
	 * 
